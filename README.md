...
Beta versions are no longer suppported, due to frequent updates. You are still able to add the needed data yourself if needed. See 'Compatibility' section below.
